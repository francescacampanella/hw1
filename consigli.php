...
<html>
    ...
    <head>
        ...
        <script src="consigli.js" defer></script>
    </head>
    ...
    <header>
        ...
        <p>1)Fai gli esercizi con la dovuta calma e il necessario controllo.<br>
        2)Solleva solo i pesi che ti permettono di eseguire con sicurezza un esercizio.<br>
        3)Tra una serie di esercizi e l’altra prevedi pause sufficienti.<br>
        4)Non dimenticare di fare qualche esercizio di riscaldamento.
        </p>
    </header>
